alias newalias='vim ~/.bash_aliases; source ~/.bashrc; savedotfiles>/dev/null'
...
alias ngrokAkceli='ngrok http 192.168.10.10:80 -host-header=akceli-new.local -subdomain=akceli-new'
