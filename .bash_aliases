...
alias refreshTesting='php artisan db:wipe --database=dronestrike --env=testing && php artisan db:wipe --database=asterisk --env=testing && php artisan migrate:fresh --env=testing --step --seed'
