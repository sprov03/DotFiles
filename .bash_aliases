...
#alias ngrokDroneStrike='ngrok http 127.0.0.1:8000 --host-header=api.dronestrike.test'
alias ngrokDroneStrike='ngrok http --url=pervasive-nakita-subrotund.ngrok-free.dev 8000 --host-header=api.dronestrike.test'
...
alias refreshTesting='php81 artisan db:wipe --database=dronestrike --env=testing && php81 artisan db:wipe --database=asterisk --env=testing && php81 artisan migrate:fresh --env=testing --step --seed'
...
alias refresh='php artisan db:wipe --database=dronestrike && php artisan db:wipe --database=asterisk && php artisan migrate:fresh --step --seed'
